...
export const callBaristNotesAPI = () => {
  const requestURL = `https://cafesync-back-production.up.railway.app/api/fran/notes`;
...
export const callBaristNoteDetailAPI = ({ noteCode }) => {
  const requestURL = `https://cafesync-back-production.up.railway.app/api/fran/notes/${noteCode}`;
...
export const callSearchNoteAPI = ({ search }) => {
  const requestURL = `https://cafesync-back-production.up.railway.app/api/fran/notes/search?search=${search}`;
